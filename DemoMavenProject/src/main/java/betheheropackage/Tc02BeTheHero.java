...
/*2	"Sign in App with the Login ID
Click on Add Test Cases,
Enter Title , Description, Value 
Click on Add Case"	"Validate Title, Description Entered
And validate ""Totally 1 TestCase"" text"*/

public class Tc02BeTheHero {
	public static void main(String[] args) throws MalformedURLException{
		...
		driver.findElement(By.xpath("//android.widget.EditText[@text='Give title']")).sendKeys("BeTheHero Test flow2");
		driver.findElement(By.xpath("//android.widget.EditText[@text='Give description']")).sendKeys("Validate BeTheHero Test Flow2");
		driver.findElement(By.xpath("//android.widget.EditText[@text='Give value']")).sendKeys("Flow 2 Test");
		driver.findElement(By.xpath("//android.widget.TextView[@text='ADD CASE']")).click();
		driver.quit();
